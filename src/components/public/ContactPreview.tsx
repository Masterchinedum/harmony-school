      ...
      <div className="container mx-auto px-6 md:px-12">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10">
          ...
          <div className="bg-white p-8 rounded-lg shadow-md">
            <div className="mb-8">
              <h3 className="text-2xl font-bold mb-4 text-harmonyPurple">Contact Information</h3>
              <div className="space-y-4">
                <div className="flex items-start">
                  <MapPinIcon className="h-6 w-6 text-harmonyPurple mr-3 flex-shrink-0" />
                ...
                <div className="flex items-center">
                  <PhoneIcon className="h-6 w-6 text-harmonyPurple mr-3 flex-shrink-0" />
                  <p className="text-gray-700">
                ...
                <div className="flex items-center">
                  <EnvelopeIcon className="h-6 w-6 text-harmonyPurple mr-3 flex-shrink-0" />
                  <p className="text-gray-700">
            ...
            <div>
              <h3 className="text-2xl font-bold mb-4 text-harmonyPurple">Send Us a Message</h3>
              <p className="mb-6 text-gray-600">
                Have a question or want to learn more? Our team is ready to help you.
              </p>
              <Link 
                href="/contact" 
                className="inline-block w-full py-3 px-6 text-center bg-harmonyPurple hover:bg-harmonyPurpleLight text-white font-semibold rounded-md transition duration-300"
              >
                Contact Us Now
              </Link>
            </div>
