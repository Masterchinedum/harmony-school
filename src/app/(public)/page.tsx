  ...
  return (
    <>
        ...
        <div className="absolute inset-0 flex items-center justify-center">
          <div className="container mx-auto px-6 md:px-12 text-center">
            <div className="max-w-4xl mx-auto">
              ...
              <p className="text-xl md:text-2xl text-primary-foreground mb-8 font-light italic">
                &quot;Educate the mind, educate the heart&quot;
              </p>
              <p className="text-lg md:text-xl text-primary-foreground mb-12 max-w-2xl mx-auto">
                Providing quality nursery, primary and secondary education in Ewu-Urhobo, Delta State
              </p>
              <div className="flex flex-col sm:flex-row justify-center gap-4">
                <Link 
                  href="/admissions" 
                  className="bg-primary hover:bg-primary/90 text-primary-foreground font-bold py-3 px-8 rounded-md transition duration-300"
                >
                  Apply for Admission
                </Link>
                <Link 
                  href="/contact" 
                  className="bg-card hover:bg-card/90 text-primary font-bold py-3 px-8 rounded-md transition duration-300"
                >
                  Schedule a Visit
                </Link>
              </div>
      ...
      <div className="relative">
        <div className="absolute top-0 left-0 right-0 h-16 bg-secondary transform -skew-y-2 origin-top-right z-0"></div>
